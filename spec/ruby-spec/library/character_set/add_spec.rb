...
describe "CharacterSet#add" do
  ...
  it "raises on incompatible <=> comparison" do
    ...
    lambda { CharacterSet['1', '2'].add(:foo).to_a }.should raise_error(ArgumentError)
  end
end
